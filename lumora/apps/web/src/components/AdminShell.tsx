  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="flex min-h-screen">
        <AdminSidebar adminName={adminName} onLogout={handleLogout} signingOut={signingOut} />
              ...
              <div className="flex gap-2 md:hidden">
                <Link
                  ...
                  className={`rounded-lg px-3 py-2 text-sm font-semibold ${
                    pathname === '/admin' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
                  }`}
                >
                  Pending
                </Link>

...
export function AuthForm({ initialMode = "login", onContinueAsGuest }: AuthFormProps) {
    ...
    try {
      ...
      try {
        ...
        if (snapshot.exists()) {
          ...
          existingAge = typeof data.age === "number" && Number.isFinite(data.age) ? Math.round(data.age) : undefined
          existingGender =
  ...
  return (
    <>
      <div
        className={`max-w-md w-full bg-white/80 backdrop-blur border border-indigo-100 rounded-2xl shadow-xl p-8 ${
          mode === "register" ? "" : "max-h-[90vh] overflow-y-auto"
        }`}
      >
        ...
        {mode === "login" ? (
          ...
          <form onSubmit={handleRegisterSubmit} className="space-y-3">
            ...
            <div className="grid gap-3 grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-indigo-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white"
                >
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-indigo-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-indigo-200 bg-white px-3 py-2 text-xs font-semibold text-indigo-700 shadow-sm transition hover:bg-indigo-50 disabled:opacity-60 disabled:cursor-not-allowed whitespace-nowrap"
                >
            ...
            <button
              ...
              className="w-full bg-indigo-600 text-white py-2.5 rounded-lg font-semibold hover:bg-indigo-700 transition disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
            >
              {loading && <Loader2 className="h-4 w-4 animate-spin" />}

...
const DEFAULT_SHOW_MS = 3700;
const REDUCED_MOTION_SHOW_MS = 1200;
const EXIT_MS = 320;
      ...
      {phase === "hidden" ? null : (
        <div
          ...
          className={`fixed inset-0 z-[100] overflow-hidden transition-opacity ${
            phase === "exiting" ? "opacity-0 duration-300" : "opacity-100 duration-300"
          }`}
        >
              ...
              <div className="splash-lockup">
                ...
                <div className="overflow-hidden pb-1">
                  <div className="splash-wordmark-track">
                    <span className="splash-wordmark-text bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text font-bold text-transparent">
                      Lumora
                    </span>
                  </div>
                </div>

...
export function AdminSidebar({ adminName, onLogout, signingOut }: AdminSidebarProps) {
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        {NAV_ITEMS.map(({ id, label, Icon }) => (
          <button
            ...
            className="w-full flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-900"
          >
